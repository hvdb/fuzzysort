...
var single = function (search, target, options) {
...
var go = function (search, targets, options) {
  ...
  var threshold = options && options.threshold || -9007199254740991
  var limit = options && options.limit || 9007199254740991
...
var goAsync = function (search, targets, options) {
  var canceled = false
...
var prepareSlow = function (target) {
  if (!target) return { target: '', _targetLowerCodes: [0/*this 0 doesn't make sense. here because an empty array causes the algorithm to deoptimize and run 50% slower!*/], _nextBeginningIndexes: null, score: null, indexes: null, obj: null } // hidden
...
var algorithm = function (searchLowerCodes, prepared, searchLowerCode) {
...
var algorithmNoTypo = function (searchLowerCodes, prepared, searchLowerCode) {
  var targetLowerCodes = prepared._targetLowerCodes
  var searchLen = searchLowerCodes.length
  var targetLen = targetLowerCodes.length
  var searchI = 0 // where we at
...
var prepareLowerCodes = function (str) {
...
export { single, go, highlight, prepare, cleanup }
